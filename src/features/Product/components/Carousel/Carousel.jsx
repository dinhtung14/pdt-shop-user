      ...
      <div className="Carousel">
        <div className="main-tab">
          <p
            ...
            className={
              isActive === 1 ? "main-tab-item active" : "main-tab-item"
            }
          >
            Best Sellers
          </p>
          <p
            ...
            className={
              isActive === 2 ? "main-tab-item active" : "main-tab-item"
            }
          >
            New Products
          </p>
          <p
            ...
            className={
              isActive === 3 ? "main-tab-item active" : "main-tab-item"
            }
          >
            Sale Products
          </p>
          ...
          {currentTab === 1 &&
            (isLoading ? (
              <Loading backgroundColor="black" />
                ...
                <ListProduct product={listProduct} onIncreasePage={handleIncreasePage} />
            ))}
